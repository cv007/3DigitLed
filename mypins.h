...
//.............................................................SETUP PINS......
    { PIN(A,0), { 0, 0, 0, 0, 0, 0, 1 } }, //[0] ledC1
    { PIN(A,1), { 0, 0, 0, 0, 0, 0, 0 } }, //[1] ledA
    { PIN(A,2), { 0, 0, 0, 0, 0, 0, 0 } }, //[2] ledF
    { PIN(C,0), { 0, 0, 0, 0, 0, 0, 0 } }, //[3] ledB
    { PIN(C,1), { 0, 0, 0, 0, 0, 0, 1 } }, //[4] ledC2
    { PIN(C,2), { 0, 0, 0, 0, 0, 0, 1 } }, //[5] ledC3

    { PIN(A,5), { 0, 0, 0, 0, 0, 0, 0 } }, //[6] ledE
    { PIN(A,4), { 0, 0, 0, 0, 0, 0, 0 } }, //[7] ledD
    { PIN(C,5), { 0, 0, 0, 0, 0, 0, 0 } }, //[8] ledDP
    { PIN(C,4), { 0, 0, 0, 0, 0, 0, 0 } }, //[9] ledC
    { PIN(C,3), { 0, 0, 0, 0, 0, 0, 0 } }, //[10] ledG
/*
           16F15325
         ----------
     Vdd |1     14| Vss
