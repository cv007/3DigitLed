...
typedef enum {
    ...
    pps_CLCIN0 = 43, pps_CLCIN1, pps_CLCIN2, pps_CLCIN3, pps_ADACTIN = 51,
    pps_SCK1IN = 53, pps_SCL1IN = 53, pps_SDI1IN, pps_SDA1IN = 54, pps_SS1IN,
...
// pin functions
//=============================================================================
void pin_init_all(void);            //init all pins in all_pins[]
void pin_init   (pin_t*);           //init pin to off, set attributes
void pin_lat    (pin_t*, bool);     //set lat to bool val
void pin_on     (pin_t*);           //set lat to 'onval'
void pin_off    (pin_t*);           //set lat to !'onval'
void pin_tog    (pin_t*);           //toggle lat
bool pin_pin    (pin_t*);           //get pin val (port)
bool pin_ison   (pin_t*);           //onval == pin_pin
void pin_ppsout (pin_t*, ppsout_t); //set pin to ppsout func
void pin_ppsoutF(pin_t*, ppsout_t); //set pin to ppsout func (faster)
void pin_ppsin  (pin_t*, ppsin_t);  //set ppsin func to pin
