...
// turn module on, off, reset (?->off->on- all regs reset), ison
//=============================================================================
void pmd_on     (pmdctrl_t md);
void pmd_off    (pmdctrl_t md);
void pmd_reset  (pmdctrl_t md);
bool pmd_ison   (pmdctrl_t md); //M_ALL returns false
